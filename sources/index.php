...
$danhmuc1baivietnb = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, id, noibat from #_news_list where type = ? and noibat > 0 and hienthi > 0 order by stt,id desc",array('danh-muc-dich-vu'));
...
$tieuchi = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, mota$lang as mota, ngaytao, id, photo from #_news where type = ?  and hienthi > 0 order by stt,id desc",array('tieu-chi'));
$diadiem = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, mota$lang as mota, ngaytao, id, photo from #_news where type = ? and noibat > 0 and hienthi > 0 order by stt,id desc",array('dia-diem-du-lich'));
...
$quangcao = $d->rawQuery("select ten$lang as ten, photo, link from #_photo where type = ? and hienthi > 0 order by stt,id desc",array('slideqc'));
