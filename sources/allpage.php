...
$slogan2 = $d->rawQueryOne("select ten$lang as ten from #_static where type = ? limit 0,1",array('slogan2'));
...
$menuhome = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, mota$lang as mota, ngaytao, id, photo from #_news where type = ? and hienthi > 0 order by stt,id desc",array('bai-viet-nut-home'));
...
/* Menu */
$splistmenu = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, id,type from #_product_list where type = ? and menu > 0 and hienthi > 0 order by stt,id desc",array('san-pham'));
$dvlistmenu = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, id,type from #_news_list where type = ? and menu > 0 and hienthi > 0 order by stt,id desc",array('danh-muc-dich-vu'));
...
$homelistmenu = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, id,type from #_news where type = ?  and hienthi > 0 order by stt,id desc",array('bai-viet-nut-home'));
/* Get statistic */
