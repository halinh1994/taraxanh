...
if($id!='')
{
	...
	$sql = "select photo, ten$lang as ten, tenkhongdauvi, tenkhongdauen, giamoi, gia,thoigian,khoihanh  giakm, id from #_product where $where order by stt,id desc $limit";
