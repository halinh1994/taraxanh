<?php  
	...
	if(isset($_GET['keyword']))
	{
		...
		if($tukhoa)
		{
			...
			$params = array("san-pham","%$tukhoa1%","%$tukhoa%","%$tukhoa%");

			$curPage = $get_page;
			$per_page = 20;
			$startpoint = ($curPage * $per_page) - $per_page;
			$limit = " limit ".$startpoint.",".$per_page;
			$sql = "select photo, ten$lang as ten, tenkhongdauvi, tenkhongdauen, giamoi,thoigian.khoihanh, gia, giakm, id from #_product where $where order by stt,id desc $limit";
