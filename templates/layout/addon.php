...
<!-- NN_FRAMEWORK.AjaxPagingProduct = function(){
...
/* Ajax tab sản phẩm*/
<script>
	NN_FRAMEWORK.AjaxSlickProduct = function(tab){
		$(tab).slick({
	...
	NN_FRAMEWORK.AjaxUnSlickProduct = function(tab){
		$(tab).slick("unslick");
	};
	NN_FRAMEWORK.AjaxSlickTab = function(){
