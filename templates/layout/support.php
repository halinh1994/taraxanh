...
<a class="btn-zalo btn-frame text-decoration-none" target="_blank" href="https://zalo.me/<?=preg_replace('/[^0-9]/','',$optsetting['zalo']);?>">
    ...
    <i><img src="assets/img/zalo.png" alt="Zalo"></i>

</a>
<a class="btn-address btn-frame text-decoration-none" target="_blank" href="https://www.google.com/maps/dir/?api=1&origin=&destination=<?=$optsetting['diachi']?>">
    <div class="animated infinite zoomIn kenit-alo-circle"></div>
    <div class="animated infinite pulse kenit-alo-circle-fill"></div>
    <i><img src="assets/img/adress.png" alt="address"></i>
