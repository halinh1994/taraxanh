        ...
        <ul>
            ...
            <li class="heading"><?=danhmucsanpham?></li>
                <?php for($i=0;$i<count($splistmenu); $i++) {
                    ...
                    <li>
                        <h2><a class="transition" title="<?=$splistmenu[$i]['ten']?>" href="<?=$splistmenu[$i][$sluglang]?>"><?=$splistmenu[$i]['ten']?></a></h2>
                        <?php if(count($spcatmenu)>0) { ?>
                            <ul>
                                <?php for($j=0;$j<count($spcatmenu);$j++) {
                                    ...
                                    <li>
                                        <h2><a class="transition" title="<?=$spcatmenu[$j]['ten']?>" href="<?=$spcatmenu[$j][$sluglang]?>"><?=$spcatmenu[$j]['ten']?></a></h2>
                                        <?php if(count($spitemmenu)) { ?>
                                            <ul>
                                                <?php for($u=0;$u<count($spitemmenu);$u++) {
                                                    ...
                                                    <li>
                                                        <h2><a class="transition" title="<?=$spitemmenu[$u]['ten']?>" href="<?=$spitemmenu[$u][$sluglang]?>"><?=$spitemmenu[$u]['ten']?></a></h2>
                                                        <?php if(count($spsubmenu)) { ?>
                                                            <ul>
                                                                <?php for($s=0;$s<count($spsubmenu);$s++) { ?>
                                                                    <li><h2>
                                                                        <a class="transition" title="<?=$spsubmenu[$s]['ten']?>" href="<?=$spsubmenu[$s][$sluglang]?>"><?=$spsubmenu[$s]['ten']?></a></h2>
                                                                    </li>
                                                                <?php } ?>
                                                            </ul>
                                                        <?php } ?>
                ...
                <?php if(count($ttlistmenu)) { ?>
                    <ul>
                        <?php for($i=0;$i<count($ttlistmenu); $i++) {
                            ...
                            <li>
                                <h2><a class="transition" title="<?=$ttlistmenu[$i]['ten']?>" href="<?=$ttlistmenu[$i][$sluglang]?>"><?=$ttlistmenu[$i]['ten']?></a></h2>
                                <?php if(count($ttcatmenu)>0) { ?>
                                    <ul>
                                        <?php for($j=0;$j<count($ttcatmenu);$j++) {
                                            ...
                                            <li>
                                                <h2><a class="transition" title="<?=$ttcatmenu[$j]['ten']?>" href="<?=$ttcatmenu[$j][$sluglang]?>"><?=$ttcatmenu[$j]['ten']?></a></h2>
                                                <?php if(count($ttitemmenu)) { ?>
                                                    <ul>
                                                        <?php for($u=0;$u<count($ttitemmenu);$u++) {
                                                            ...
                                                            <li>
                                                                <h2><a class="transition" title="<?=$ttitemmenu[$u]['ten']?>" href="<?=$ttitemmenu[$u][$sluglang]?>"><?=$ttitemmenu[$u]['ten']?></a></h2>
                                                                <?php if(count($ttsubmenu)) { ?>
                                                                    <ul>
                                                                        <?php for($s=0;$s<count($ttsubmenu);$s++) { ?>
                                                                            <li>
                                                                                <h2><a class="transition" title="<?=$ttsubmenu[$s]['ten']?>" href="<?=$ttsubmenu[$s][$sluglang]?>"><?=$ttsubmenu[$s]['ten']?></a></h2>
                                                                            </li>
                                                                        <?php } ?>
                                                                    </ul>
                                                                <?php } ?>
