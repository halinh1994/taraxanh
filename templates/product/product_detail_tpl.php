        ...
        */ ?>
        <div class="pro-detail-desc">   
            ...
            <?php if(!empty($row_detail['masp'])) { ?>  
                <p> <span>  Mã tour:</span> <?=$row_detail['masp']?></p>
            <?php } ?>
            <?php if(!empty($row_detail['thoigian'])) { ?>  
                <p> <span>  Thời gian:</span> <?=$row_detail['thoigian']?></p>  
            <?php } ?>
            <?php if(!empty($row_detail['khoihanh'])) { ?>    
                <p> <span>  Khởi hành:</span> <?=$row_detail['khoihanh']?></p>    
            <?php } ?>
        </div>
