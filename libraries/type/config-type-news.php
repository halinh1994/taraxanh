<?php
    ...
    $config['news'][$nametype]['title_main'] = "Danh mục dịch vụ";
    ...
    $config['news'][$nametype]['height'] = 540;
    $config['news'][$nametype]['thumb'] = '540x540x1';
    ...
    $config['news'][$nametype]['width_cat'] = 300;
    $config['news'][$nametype]['height_cat'] = 200;
    ...
    $config['news'][$nametype]['seo'] = true;
    $config['news'][$nametype]['schema'] = true;
    $config['news'][$nametype]['width'] = 53;
    $config['news'][$nametype]['height'] = 51;
    $config['news'][$nametype]['thumb'] = '53x51x1';
    $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
     
     /* Địa điểm du lịch */
    $nametype = "dia-diem-du-lich";
    $config['news'][$nametype]['title_main'] = "Địa điểm du lịch";
    $config['news'][$nametype]['dropdown'] = false;
    $config['news'][$nametype]['list'] = false;
    $config['news'][$nametype]['cat'] = false;
    $config['news'][$nametype]['item'] = false;
    ...
    $config['news'][$nametype]['seo'] = true;
    $config['news'][$nametype]['schema'] = true;
    $config['news'][$nametype]['width'] = 202;
    $config['news'][$nametype]['height'] = 202;
    $config['news'][$nametype]['thumb'] = '202x202x1';
    $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
    
        /* Bài viết nút home */
    $nametype = "bai-viet-nut-home";
    $config['news'][$nametype]['title_main'] = "Bài viết nút home";
    $config['news'][$nametype]['dropdown'] = false;
    $config['news'][$nametype]['list'] = false;
    $config['news'][$nametype]['cat'] = false;
    $config['news'][$nametype]['item'] = false;
    ...
    $config['news'][$nametype]['height'] = 755;
    $config['news'][$nametype]['thumb'] = '560x755x1';
    $config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
       /* Chính sách */
    $nametype = "chinh-sach";
