...
$requick = array(
	...
	/* Tin tức */
		array("tbl"=>"news_list","field"=>"idl","source"=>"news","com"=>"danh-muc-dich-vu","type"=>"danh-muc-dich-vu"),
		array("tbl"=>"news_cat","field"=>"idc","source"=>"news","com"=>"danh-muc-dich-vu","type"=>"danh-muc-dich-vu"),
		// array("tbl"=>"news_item","field"=>"idi","source"=>"news","com"=>"danh-muc-dich-vu","type"=>"danh-muc-dich-vu"),
		// array("tbl"=>"news_sub","field"=>"ids","source"=>"news","com"=>"danh-muc-dich-vu","type"=>"danh-muc-dich-vu"),
	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"danh-muc-dich-vu","type"=>"danh-muc-dich-vu",'menu'=>true),
