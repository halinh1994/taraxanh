...
if($(".paging-news-category").exists())
{
    $(".paging-news-category").each(function(){
        var list = $(this).data("list");
        loadPagingAjax("ajax/ajax_news.php?perpage=6&idList="+list,'.paging-news-category-'+list);
    })
}
...
NN_FRAMEWORK.OwlPage = function(){
 ...
 if($(".owl-advertise").exists())
    ...
    if($(".owl-tourist-attraction").exists())
    {
        $('.owl-tourist-attraction').owlCarousel({
            items: 4,
            rewind: true,
            autoplay: true,
            loop: false,
