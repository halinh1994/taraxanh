		                        ...
		                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
		                            <?php foreach($config['website']['lang'] as $k => $v) { ?>
		                                <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
		                                    ...
		                                    <?php if(isset($config['product'][$type]['khoihanh']) && $config['product'][$type]['khoihanh'] == true) { ?>
		                                        <div class="form-group">
		                                           <label for="khoihanh<?=$k?>">Khởi hành:</label>
		                                        <input type="text" class="form-control for-seo" name="data[khoihanh]" id="khoihanh" placeholder="Khởi hành " value="<?=@$item['khoihanh']?>" ?>
		                                        </div>
		                                    <?php } ?>
		                                    <?php if(isset($config['product'][$type]['thoigian']) && $config['product'][$type]['thoigian'] == true) { ?>
		                                        <div class="form-group">
		                                           <label for="thoigian">Thời gian :</label>
		                                        <input type="text" class="form-control for-seo" name="data[thoigian]" id="thoigian" placeholder="Thời gian " value="<?=@$item['thoigian']?>" ?>
		                                        </div>
		                                    <?php } ?>
